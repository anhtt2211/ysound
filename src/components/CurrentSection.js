import {
  CircularProgress, Grid, Tab, Tabs, withStyles
} from '@material-ui/core';
import {
  Favorite, GetApp, History, Home
} from '@material-ui/icons/';
import React, {
  lazy, Suspense, useCallback, useContext, useEffect, useState
} from 'react';
import {
...
import {
  db, getDownloadedSongs, getHistory,
  getLikedSongs, removeDownloadingState
